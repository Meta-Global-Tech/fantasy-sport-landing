    ...
    <section id="download" className="py-28 px-6 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto relative z-10 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-16">
          ...
          >
            <svg viewBox="0 0 24 24" className="w-8 h-8 fill-white/20">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, rgba(0,230,118,0.1), rgba(22,40,69,0.8))",
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/55 text-lg mb-8 max-w-md mx-auto">
              Thousands of cricket fans are already earning. Join the action —
              your first contest is just one click away.
            </p>
            <Link
              href="https://app.procrick.com"
              target="_blank"
